...
public struct ArtifactManager {
    ...
    let anomalies =
      extraAnomalies + [
        ArtifactAnomaly(
          ...
          message: "SwiftPM-backed server runs do not produce an xcresult bundle.", phase: "swiftpm"
        ),
        ArtifactAnomaly(
          code: "not_applicable_diagnostics",
          message: "SwiftPM-backed server runs do not export xcresult diagnostics.",
          phase: "swiftpm"),
        ArtifactAnomaly(
          code: "not_applicable_attachments",
          message: "SwiftPM-backed server runs do not export xcresult attachments.",
          phase: "swiftpm"),
        ArtifactAnomaly(
          code: "not_applicable_recording",
          message: "SwiftPM-backed server runs do not produce simulator recordings.",
          phase: "swiftpm"),
        ArtifactAnomaly(
          code: "not_applicable_screen_capture",
          message: "SwiftPM-backed server runs do not produce simulator screenshots.",
          phase: "swiftpm"),
        ArtifactAnomaly(
          code: "not_applicable_ui_tree",
          message: "SwiftPM-backed server runs do not produce simulator UI trees.", phase: "swiftpm"
        ),
      ]
  ...
  public func resolveArtifacts(workspace: WorkspaceContext, request: ArtifactsCommandRequest) throws
    -> String
  {
  ...
  private func createOptionalAliases(
