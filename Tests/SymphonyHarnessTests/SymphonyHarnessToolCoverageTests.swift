...
private final class InvocationConcurrencyBox: @unchecked Sendable {
  private let lock = NSLock()
...
private final class RecordingWorkspaceDiscovery: WorkspaceDiscovering, @unchecked Sendable {
  private let lock = NSLock()
