...
@Test func codexProviderConfigDefaults() {
  ...
  #expect(config.threadSandbox == nil)
...
@Test func workflowParserFullConfigParsing() throws {
  ...
  #expect(c.providers.codex.approvalPolicy == "auto")
  #expect(c.providers.codex.threadSandbox == "none")
...
@Test func workflowParserPartialSectionDefaults() throws {
  ...
  #expect(def.config.providers.codex.approvalPolicy == "manual")
