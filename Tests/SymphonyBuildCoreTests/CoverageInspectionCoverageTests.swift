...
@Test func swiftPMCoverageInspectorResolvesContextAndParsesFunctionsAndMissingLines() throws {
  try withTemporaryDirectory { directory in
    ...
    let filePath = repoRoot.appendingPathComponent("Sources/SymphonyRuntime/BootstrapSupport.swift")
      .path
    let showCommand =
...
@Test func coverageInspectionUtilitiesCoverFallbackBranchesAndRenderingHelpers() throws {
  try withTemporaryDirectory { directory in
    ...
    do {
      ...
      #expect(
        error.message
          == "Failed to inspect SwiftPM missing lines for Sources/SymphonyRuntime/BootstrapSupport.swift."
      )
    }
    ...
    do {
      ...
      #expect(
        error.message
          == "Failed to inspect SwiftPM functions for Sources/SymphonyRuntime/BootstrapSupport.swift."
      )
    }
  }
